!function (e) {
    ...
    0: function (e, t, n) {
        ...
        n(385), n(191);
        var r = n(193), i = o(r), a = n(192), u = o(a), l = n(129);
        ...
        var o = n(5), r = n(25), i = n(91), a = n(13), u = "prototype", l = function (e, t, n) {
            var s, c, f, p = e & l.F, d = e & l.G, m = e & l.S, h = e & l.P, v = e & l.B, y = e & l.W,
        ...
        "use strict";
        var o = n(36), r = n(51), i = n(64), a = n(13), u = n(8), l = n(35), s = n(96), c = n(38), f = n(103),
        ...
        e.exports = function (e, t, n, g, w, x, b) {
            ...
            var C, S, T, I = function (e) {
                ...
                }, E = t + " Iterator", _ = w == v, O = !1, R = e.prototype, k = R[p] || R[m] || w && R[w], D = k || I(w),
                M = w ? _ ? I("entries") : D : void 0, A = "Array" == t ? R.entries || k : k;
            if (A && (T = f(A.call(new e)), T !== Object.prototype && (c(T, E, !0), o || u(T, p) || a(T, p, y))), _ && k && k.name !== v && (O = !0, D = function () {
                    ...
                    keys: x ? D : I(h),
                    entries: M
                }, b)for (S in C)S in R || i(R, S, C[S]); else r(r.P + r.F * (d || O), t, C);
            return C
        }
    }, 60: function (e, t, n) {
        ...
        e.exports = function (e) {
            return function (t, n, a) {
                var u, l = o(t), s = r(l.length), c = i(a, s);
                if (e && n != n) {
        ...
        var o = n(37), r = n(22), i = n(9), a = n(42), u = n(8), l = n(58), s = Object.getOwnPropertyDescriptor;
        ...
        e.exports = function (e) {
            return function (t, n) {
                var i, a, u = String(r(t)), l = o(n), s = u.length;
        ...
        "use strict";
        var o = n(5), r = n(8), i = n(12), a = n(51), u = n(64), l = n(99).KEY, s = n(18), c = n(40), f = n(38),
            p = n(23),
            d = n(15), m = n(44), h = n(43), v = n(98), y = n(92), g = n(95), w = n(20), x = n(9), b = n(42), C = n(22),
            S = n(60), T = n(102), I = n(101), E = n(14), _ = n(19), O = I.f, R = E.f, k = T.f, D = o.Symbol,
            M = o.JSON,
            A = M && M.stringify, F = "prototype", P = d("_hidden"), L = d("toPrimitive"), j = {}.propertyIsEnumerable,
            N = c("symbol-registry"), Z = c("symbols"), U = c("op-symbols"), z = Object[F], B = "function" == typeof D,
            q = o.QObject, W = !q || !q[F] || !q[F].findChild, K = i && s(function () {
                return 7 != S(R({}, "a", {
                        get: function () {
                ...
                return e === z && G(U, t, n), w(e), t = b(t, !0), w(n), r(Z, t) ? (n.enumerable ? (r(e, P) && e[P][t] && (e[P][t] = !1), n = S(n, {enumerable: C(0, !1)})) : (r(e, P) || R(e, P, C(1, {})), e[P][t] = !0), K(e, t, n)) : R(e, t, n)
            }, Y = function (e, t) {
                w(e);
        ...
        for (var o = n(5), r = n(13), i = n(35), a = n(15)("toStringTag"), u = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], l = 0; l < 5; l++) {
            var s = u[l], c = o[s], f = c && c.prototype;
        ...
        var l = n(156), s = o(l), c = n(157), f = o(c), p = function () {
        ...
        var i = n(389), a = o(i), u = n(388), l = o(u);
        n(383), n(384), window.PhotoSwipe = a.default, window.PhotoSwipeUI_Default = l.default, e.exports = {init: r}
    }, 196: function (e, t, n) {/*!
     * @module report
     ...
     */
                ...
                function o(t, r, i) {
                    ...
                    if ("undefined" != typeof document) {
                        ...
                        for (var c = document.cookie ? document.cookie.split("; ") : [], f = /(%[0-9A-Z]{2})+/g, p = 0; p < c.length; p++) {
                            var d = c[p].split("="), m = d.slice(1).join("=");
        ...
        !function (i, a) {
            ...
            "use strict";
            var e = function (e, t) {
                var n, o, r, i, a, u, l, s, c, f, p, d, m, h, v, y, g, w, x, b = this, C = !1, S = !0, T = !0, I = {
        ...
        !function (i, a) {
            ...
            var e = function (e, t, n, o) {
                ...
                r.extend(l, o);
                var s, c, f, p, d, m, h, v, y, g, w, x, b, C, S, T, I, E, _, O, R, k, D, M, A, F, P, L, j, N, Z, U, z,
                    B, q, W,
                    K, J, H, G, Y, V, X, $, Q, ee, te, ne, oe, re, ie, ae, ue, le, se, ce, fe, pe = function () {
                        return {x: 0, y: 0}
                    }, de = pe(), me = pe(), he = pe(), ve = {}, ye = 0, ge = {}, we = pe(), xe = 0, be = !0, Ce = [],
                    Se = {},
                    Te = !1, Ie = function (e, t) {
                    ...
                    }, it = 30, at = 10, ut = {}, lt = {}, st = {}, ct = {}, ft = {}, pt = [], dt = {}, mt = [], ht = {},
                    vt = 0,
                    yt = pe(), gt = 0, wt = pe(), xt = pe(), bt = pe(), Ct = function (e, t) {
                        ...
                        var n, o, r, a, u = 0, s = he[e] + t[e], c = t[e] > 0, f = wt.x + t.x, p = wt.x - dt.x;
                        ...
                        if (Q) {
                            var e = Q.length;
                            if (0 !== e)if (Ne(ut, Q[0]), st.x = ut.x - ct.x, st.y = ut.y - ct.y, ee && e > 1) {
                                if (ct.x = ut.x, ct.y = ut.y, !st.x && !st.y && Ct(Q[1], lt))return;
                                Ne(lt, Q[1]), Y || (Y = !0, Re("zoomGestureStarted"));
                                var t = Tt(ut, lt), n = Ht(t);
                                n > i.currItem.initialZoomLevel + i.currItem.initialZoomLevel / 15 && (ce = !0);
                                var o = 1, r = Ke(), a = Je();
                                if (n < r)if (l.pinchToClose && !ce && w <= i.currItem.initialZoomLevel) {
                                    var u = r - n, s = 1 - u / (r / 1.2);
                        ...
                        var c = -1;
                        if (0 === s && (H = !1, r.unbind(window, h, i), It(), ee ? c = 0 : gt !== -1 && (c = ke() - gt)), gt = 1 === s ? ke() : -1, a = c !== -1 && c < 150 ? "zoom" : "swipe", ee && s < 2 && (ee = !1, 1 === s && (a = "zoomPointerUp"), Re("zoomGestureEnded")), Q = null, V || Y || ie || K)if (nt(), q || (q = Wt()), q.calculateSwipeSpeed("x"), K) {
                            var f = Ft();
                        ...
                        var o;
                        if ("swipe" === e) {
                            var a = ct.x - ft.x, u = t.lastFlickDist.x < 10;
                        ...
                        var c, f = we.x * ye, d = Math.abs(f - wt.x);
                ...
                var Yt, Vt, Xt, $t, Qt, en, tn, nn = function (t, n, o, a) {
                    ...
                    var s = o ? l.hideAnimationDuration : l.showAnimationDuration, c = function () {
                    ...
                    var d = function () {
                        ...
                        t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), o || (g = u.w / t.w, he.x = u.x, he.y = u.y - L, i[a ? "template" : "bg"].style.opacity = .001, Ae()), tt("initialZoom"), o && !n && r.removeClass(e, "pswp--animated-in"), a && (o ? r[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                            ...
                            if (Re("initialZoom" + (o ? "Out" : "In")), o) {
                                var i = u.w / t.w, l = {x: he.x, y: he.y}, f = g, p = se, d = function (t) {
                ...
                Ie("Controller", {
                    publicMethods: {
                        lazyLoadItem: function (e) {
                            ...
                            if (!a.src && a.html && (a.html.tagName ? u.appendChild(a.html) : u.innerHTML = a.html), pn(a), sn(a, ve), !a.src || a.loadError || a.loaded) a.src && !a.loadError && (o = r.createEl("pswp__img", "img"), o.style.opacity = 1, o.src = a.src, dn(a, o), cn(t, a, u, o, !0)); else {
                ...
                var wn, xn, bn, Cn, Sn, Tn, In, En, _n, On, Rn, kn, Dn = {history: !0, galleryUID: 1},
                    Mn = function () {
